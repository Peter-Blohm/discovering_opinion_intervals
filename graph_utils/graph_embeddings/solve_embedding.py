...
if __name__ == "__main__":
    ...
    #file = "graph_0.txt"
    file = "data/all20graphs/graph_0.txt"
    ...
    vertices = list(graph.G_plus.nodes)

    # Generate a random permutation of the vertices
    
    disjoint_aux = generate_disjoint_aux_vars(permutation)

    embeddable, start, end = check_embeddability(file, disjoint_aux)
    print(embeddable)
